...
function insert2(string $ref, string $tableName, array $toInsert) {
    $campos = "(".implode(', ', array_keys($toInsert)).")";
    $valores = "('".implode("','", array_values($toInsert))."')";
    return str_replace('valores', $valores, str_replace('campos', $campos, str_replace('taula', $tableName, $ref)));
}
